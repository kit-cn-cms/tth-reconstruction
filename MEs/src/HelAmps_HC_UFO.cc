    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  P2[2] = V2[1].imag(); 
  P2[3] = V2[0].imag(); 
  TMP9 = -1. * (P1[0] * (P2[1] * (V2[4] * V1[5] - V2[5] * V1[4]) + (P2[2] *
      ...
      V1[3]))))));
  TMP10 = -1. * (P1[0] * (P2[1] * (V2[5] * V1[4] - V2[4] * V1[5]) + (P2[2] *
      ...
      V1[2]))))));
  vertex = COUP * 4. * S3[2] * (-cI * (TMP10) + cI * (TMP9)); 
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP15 = (F1[4] * F2[4] + F1[5] * F2[5]); 
  TMP14 = (F1[2] * F2[2] + F1[3] * F2[3]); 
  vertex = COUP * - S3[2] * (+cI * (TMP14 + TMP15)); 
}
    ...
    complex<double> COUP, double M3, double W3, complex<double> S3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * 4. * S4[2] * (-cI * (TMP9) + cI * (TMP10)); 
}
    ...
    complex<double> S3[])
{
  ...
  int i; 
  VVSS1_3(V1, V2, S4, COUP1, M3, W3, S3); 
  VVSS3_3(V1, V2, S4, COUP2, M3, W3, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S3[i] = S3[i] + Stmp[i]; 
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  vertex = COUP * S3[2] * (-cI * (TMP4 * TMP7) + cI * (TMP1 * TMP12)); 
}
    ...
    S4[], complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * - 4. * cI * S4[2] * (V2[3] * (V3[4] * - 1. * (P1[3] + P2[3] +
      P3[3]) + V3[5] * (P1[2] + P2[2] + P3[2])) + (V2[4] * (V3[3] * (P1[3] +
      P2[3] + P3[3]) - V3[5] * (P1[1] + P2[1] + P3[1])) + V2[5] * (V3[3] * - 1.
      * (P1[2] + P2[2] + P3[2]) + V3[4] * (P1[1] + P2[1] + P3[1]))));
  V1[3] = denom * 4. * cI * S4[2] * (V2[2] * (V3[4] * (P1[3] + P2[3] + P3[3]) -
      V3[5] * (P1[2] + P2[2] + P3[2])) + (V2[4] * (V3[2] * - 1. * (P1[3] +
      P2[3] + P3[3]) + V3[5] * (P1[0] + P2[0] + P3[0])) + V2[5] * (V3[2] *
      (P1[2] + P2[2] + P3[2]) - V3[4] * (P1[0] + P2[0] + P3[0]))));
  V1[4] = denom * 4. * cI * S4[2] * (V2[2] * (V3[3] * - 1. * (P1[3] + P2[3] +
      P3[3]) + V3[5] * (P1[1] + P2[1] + P3[1])) + (V2[3] * (V3[2] * (P1[3] +
      P2[3] + P3[3]) - V3[5] * (P1[0] + P2[0] + P3[0])) + V2[5] * (V3[2] * - 1.
      * (P1[1] + P2[1] + P3[1]) + V3[3] * (P1[0] + P2[0] + P3[0]))));
  V1[5] = denom * 4. * cI * S4[2] * (V2[2] * (V3[3] * (P1[2] + P2[2] + P3[2]) -
      V3[4] * (P1[1] + P2[1] + P3[1])) + (V2[3] * (V3[2] * - 1. * (P1[2] +
      P2[2] + P3[2]) + V3[4] * (P1[0] + P2[0] + P3[0])) + V2[4] * (V3[2] *
      (P1[1] + P2[1] + P3[1]) - V3[3] * (P1[0] + P2[0] + P3[0]))));
}
    ...
    complex<double> V1[])
{
  ...
  VVVS1P0_1(V2, V3, S4, COUP1, M1, W1, V1); 
  VVVS2P0_1(V2, V3, S4, COUP2, M1, W1, Vtmp); 
  i = 2; 
  while (i < 6)
  {
    V1[i] = V1[i] + Vtmp[i]; 
    ...
    complex<double> COUP, double M3, double W3, complex<double> S3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * S4[2] * (-cI * (TMP1 * TMP12) + cI * (TMP4 * TMP7)); 
}
    ...
    S4[], complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * S4[2] * (TMP6 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] *
      (-cI * (TMP0) + cI * (TMP2)) + V3[2] * (-cI * (TMP5) + cI * (TMP4))));
  V1[3] = denom * S4[2] * (TMP6 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] *
      (-cI * (TMP0) + cI * (TMP2)) + V3[3] * (-cI * (TMP5) + cI * (TMP4))));
  V1[4] = denom * S4[2] * (TMP6 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] *
      (-cI * (TMP0) + cI * (TMP2)) + V3[4] * (-cI * (TMP5) + cI * (TMP4))));
  V1[5] = denom * S4[2] * (TMP6 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] *
      (-cI * (TMP0) + cI * (TMP2)) + V3[5] * (-cI * (TMP5) + cI * (TMP4))));
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * S3[2] * (-cI * (P2[0] * TMP4) + cI * (V2[2] * TMP12)); 
  V1[3] = denom * S3[2] * (-cI * (P2[1] * TMP4) + cI * (V2[3] * TMP12)); 
  V1[4] = denom * S3[2] * (-cI * (P2[2] * TMP4) + cI * (V2[4] * TMP12)); 
  V1[5] = denom * S3[2] * (-cI * (P2[3] * TMP4) + cI * (V2[5] * TMP12)); 
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * - 8. * cI * S3[2] * (P1[1] * (V2[4] * P2[3] - V2[5] * P2[2])
      + (P1[2] * (V2[5] * P2[1] - V2[3] * P2[3]) + P1[3] * (V2[3] * P2[2] -
      V2[4] * P2[1])));
  V1[3] = denom * 8. * cI * S3[2] * (P1[0] * (V2[5] * P2[2] - V2[4] * P2[3]) +
      (P1[2] * (V2[2] * P2[3] - V2[5] * P2[0]) + P1[3] * (V2[4] * P2[0] - V2[2]
      * P2[2])));
  V1[4] = denom * 8. * cI * S3[2] * (P1[0] * (V2[3] * P2[3] - V2[5] * P2[1]) +
      (P1[1] * (V2[5] * P2[0] - V2[2] * P2[3]) + P1[3] * (V2[2] * P2[1] - V2[3]
      * P2[0])));
  V1[5] = denom * 8. * cI * S3[2] * (P1[0] * (V2[4] * P2[1] - V2[3] * P2[2]) +
    ...
    COUP1, complex<double> COUP2, double M1, double W1, complex<double> V1[])
{
  ...
  int i; 
  complex<double> Vtmp[6]; 
  VVS2P0_1(V2, S3, COUP1, M1, W1, V1); 
  VVS6P0_1(V2, S3, COUP2, M1, W1, Vtmp); 
  i = 2; 
  while (i < 6)
  {
    V1[i] = V1[i] + Vtmp[i]; 
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP13 = (F1[4] * F2[4] + F1[5] * F2[5] - F1[2] * F2[2] - F1[3] * F2[3]); 
...
}  // end namespace $(namespace)s_HC_UFO
